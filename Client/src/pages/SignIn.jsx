...
function SignIn() {
    ...
    async function register(e) {
        e.preventDefault()
        const response = await fetch('https://myfitnesstrack-server1.onrender.com/api/register', {
            body: JSON.stringify({
                username,
                password,
                fullname,
    ...
    async function login(e) {
        ...
        const response = await fetch('https://myfitnesstrack-server1.onrender.com/api/login', {
            method: 'POST',
            body: JSON.stringify({
                username,
                password,
